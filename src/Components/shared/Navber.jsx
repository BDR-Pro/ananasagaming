...
const Navber = () => {
    ...
    return (
        <>
            ...
            <div className="md:hidden flex justify-between items-center pr-3 py-1 fixed z-50 w-full backdrop-blur-xl bg-white/30">
                <Link to="/">
                    <img src={logo} alt="" width={150} height={150} style={{ filter: 'hue-rotate(120deg)' }} />
                </Link>
                <div className="">
                        ...
                        <li><button onClick={() => handleButton(!toggle)} className='btn btn-sm btn-ghost'><FaBars size={25} /></button></li>
                        {
                            ...
                            <div className='md:hidden absolute w-[220px] px-3 py-2 rounded-lg bg-slate-400 right-0 top-[50px] shadow-xl'>
                                <ul className='flex flex-col gap-1'>
                                    <li><Link to="/" className='block border-2 rounded-md px-3 py-2 text-center border-blue-950 hover:bg-white hover:text-blue-950 font-bold bg-blue-950 text-white'>Home</Link></li>
